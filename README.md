...
2. V **SQL Editoru** spusť postupně soubory z `supabase/migrations/`:
   ...
   - `0004`–`0022` — pozdější rozšíření (střídání po sudých týdnech, okresy,
     ...
     a noc na dni předání, předplatné, paywall, opakované výdaje, měření provozu a zprávy se záznamem)
